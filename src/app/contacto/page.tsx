      ...
      <div className="gradient-card rounded-3xl p-8 shadow-lg shadow-reiki-200/20 border border-white/50">
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-reiki-100 to-reiki-100 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-reiki-100 to-reiki-200 flex items-center justify-center flex-shrink-0">
              <svg className="w-6 h-6 text-reiki-600" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <a href={`https://wa.me/${config.contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-reiki-600 hover:text-reiki-700">
