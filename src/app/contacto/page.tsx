  ...
  return (
    <div className="space-y-8">
      <div className="gradient-card rounded-3xl p-8 shadow-lg shadow-reiki-200/20 border border-white/50">
        <h3 className="font-display text-xl font-bold text-reiki-800 mb-6">
          {t("contacto.info.title")}
        </h3>
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-reiki-100 to-heal-100 flex items-center justify-center flex-shrink-0">
              <svg className="w-6 h-6 text-reiki-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-heal-100 to-heal-200 flex items-center justify-center flex-shrink-0">
              <svg className="w-6 h-6 text-heal-600" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-medium text-reiki-800">{t("contacto.info.location")}</p>
      ...
      <div className="gradient-card rounded-3xl p-8 shadow-lg shadow-reiki-200/20 border border-white/50">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-heal-100 to-heal-200 flex items-center justify-center flex-shrink-0">
            <svg className="w-6 h-6 text-heal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <div>
            <h3 className="font-display text-lg font-bold text-reiki-800 mb-2">{t("contacto.info.hours")}</h3>
            <p className="text-reiki-600">{t("contacto.info.hoursDetail")}</p>
          </div>
        </div>
      </div>
    </div>
