        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonios.map((item, i) => (
              <div
                key={i}
                className="gradient-card rounded-3xl p-8 shadow-sm border border-white/50 hover:shadow-lg transition-all duration-300 reveal"
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-reiki-300 to-reiki-500 flex items-center justify-center text-white font-bold">
                    {item.name[0]}
                  </div>
                  <div>
                    <p className="font-semibold text-reiki-800">{item.name}</p>
